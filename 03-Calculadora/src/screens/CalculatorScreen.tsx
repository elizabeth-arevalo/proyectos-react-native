...
export const CalculatorScreen = () => {
    const { formula, number, prevNumber, buildNumber, toggleSign, clean, deleteOperation, divideOperation, addOperation, subtractOperation, multiplyOperation, calculateResult } = useCalculator();

    return (
        <View style={styles.calculatorContainer}>
            <View style={{ paddingHorizontal: 15, paddingBottom: 15 }}>
                <Text adjustsFontSizeToFit numberOfLines={1} style={styles.mainResults}>
                    {formula}
                </Text>
